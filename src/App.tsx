...
function App() {
  ...
  return (
    <>
      <Navbar />
      {loading && <div className='flex h-96 items-center justify-center' role="status">
      ...
      {!loading && <div className='max-sm:w-full w-2/3 mt-8 flex gap-8 mx-auto'>  
        ...
        <div className='max-sm:w-full w-2/5 relative mt-4'>
          <input
            type="text"
